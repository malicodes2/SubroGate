...
3. **Google GenAI SDK & Vertex AI Integration**: Agent layers adhere to stateless prompt execution, structured Pydantic tool schemas, and verifiable audit trails.
