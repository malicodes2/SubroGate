...
gcloud run deploy $ServiceName `
  ...
  --max-instances="5" `
  --port="8080" `
  --set-env-vars="SUBROGATE_ENV=production,SUBROGATE_GEMINI_MODEL=gemini-3.5-flash,SUBROGATE_USE_VERTEX=true,GOOGLE_CLOUD_PROJECT=$ProjectId,GOOGLE_CLOUD_LOCATION=$Region"
